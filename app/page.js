      ...
      <div className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-4xl mx-auto px-6 py-5">
          <h1 className="text-3xl font-bold text-gray-900">
            🚀 AI Social Media Tweet Generator
          </h1>
          <p className="text-gray-500 text-sm mt-1">
            Create engaging tweets for your brand using the power of AI.
          </p>
        </div>
      </div>
        ...
        {loading && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 font-medium">
              Generating tweets for your brand...
            </p>
            <p className="text-gray-400 text-sm mt-1">
              This may take a few seconds. Grab a coffee! ☕
            </p>
          </div>
        )}
        ...
        {result && !loading && (
          <div>
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">
              🚀 Generated Tweets for {result.brandName}
            </h2>
